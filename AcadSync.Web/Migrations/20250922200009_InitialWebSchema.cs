...
namespace AcadSync.Web.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViolationsFound = table.Column<int>(type: "int", nullable: false),
                    ViolationsProcessed = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebRuns", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RunLogs_WebRuns_RunId",
                        column: x => x.RunId,
                        principalSchema: "acadsync",
                        principalTable: "WebRuns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
